...
export abstract class TemplatedItemsComponent implements DoCheck, OnDestroy, AfterContentInit {
    public abstract get nativeElement(): FoldingListView
    ...
    constructor(_elementRef: ElementRef, private _iterableDiffers: IterableDiffers) {
        ...
        this.templatedItemsView.on('itemLoading', this.onItemLoading);
        this.templatedItemsView.on('itemTap', this.onItemTap);
        this.templatedItemsView.on('loadMoreItems', this.onLoadMoreItems);
        this.templatedItemsView.on('tap', this.onTap);
    }
    ...
    ngOnDestroy() {
        ...
        this.templatedItemsView.off('itemTap', this.onItemLoading, this);
        this.templatedItemsView.off('loadMoreItems', this.onItemLoading, this);
        this.templatedItemsView.off('tap', this.onItemLoading, this);
    ...
    public onItemLoading(args: ItemEventData) {
        ...
        if (args.view) {
            ...
            if (!viewRef && isLogEnabled()) {
                listViewLog(`ViewReference not found for item ${index}. View recycling is not working`);
            }
        }
